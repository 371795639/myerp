...
--
-- Host: localhost:8889
-- Generation Time: Jun 14, 2020 at 08:09 AM
...
(1, 'admin', 'a66abb5684c45962d887564f08346e8d', 1, '管理员', '15274888145', NULL, 0, '', NULL, NULL, NULL, NULL, NULL),
...
(211, NULL, '::1', NULL, '登陆成功 用户名：admin', 1, NULL, '2020-06-14 11:49:14', '', '2020-06-14'),
(212, NULL, '::1', NULL, '登陆成功 用户名：admin', 1, NULL, '2020-06-14 12:31:28', '', '2020-06-14'),
(213, NULL, '::1', NULL, '登陆成功 用户名：admin', 1, NULL, '2020-06-14 14:07:04', '', '2020-06-14'),
(214, 1, '::1', '管理员', '密码修改成功 UID：1 真实姓名改为：管理员', 1, 'admin', '2020-06-14 14:08:19', '', '2020-06-14');
...
--
ALTER TABLE `ci_category`
  MODIFY `id` smallint(6) NOT NULL AUTO_INCREMENT COMMENT '导航栏目',AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `ci_staff`
  MODIFY `id` smallint(6) NOT NULL AUTO_INCREMENT COMMENT '导航栏目',AUTO_INCREMENT=3;
--
